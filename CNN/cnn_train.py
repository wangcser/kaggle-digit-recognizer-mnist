...
from data_set.data_pre_process import Load_data, Load_full_data, use_comp_test
...
class Solver(object):
    ...
    def train(self, mode='First'):
        ...
        self.history = self.model.fit_generator(self.data_argumentor.flow(self.x_train, self.y_train, batch_size=self.batch_size),
